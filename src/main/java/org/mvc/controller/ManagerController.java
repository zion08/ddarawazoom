...
//  =========== 관리자 방문자 관련 코드 시작 ===========  //	
	...
	public String visitor(Model model, @RequestParam(value="visitDate", required = false, defaultValue = "") String visitDate) {
		...
		model.addAttribute("searchVisitorCount", managerService.searchVisitorCount(visitDate));
