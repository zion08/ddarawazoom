	            ...
	            <div class="card">
	                <div class="card-body">
	                    ...
	                    <div class="table-responsive">
	                    	<input type="button" class="btn btn-default" id="notice_button" onclick="window.location='/manager/noticeWrite'" value="작성하기">
		                                ...
		                                <tr>
		                                    ...
		                                    <td>
		                                    	<c:if test="${noticeList.target_id eq 'All'}">
		                                    		<a href="/manager/noticeViewCount?num=${noticeList.num}&pageNum=${pageNum}">
		                                    			${noticeList.title}
		                                    		</a>
	                                    		</c:if>
		                                    ...
		                                    <td>
		                                    	<input type="button" class="btn btn-outline-black" onclick="window.location='/manager/noticeUpdate?num=${noticeList.num}'" value="수정"/>
