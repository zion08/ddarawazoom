					...
					<div class="row g-3">
						<span class="border border-3">
							...
							<div class="col-12">
								...
								<input type="hidden" name="c_nick" value="${ZoomDTO.c_nick}">
							<div class="form-control">${ZoomDTO.c_nick}</div>
							</div>
							&nbsp;
							<div class="col-12">
							...
							<div class="col-12">
								...
								<textarea class="form-control" name="intro" value="${ZoomDTO.intro}">${ZoomDTO.intro}</textarea>
							</div>
							&nbsp;
							<div class="col-12">
