...
<div class="container">
    ...
    <div class="col">
      ...
      <ul class="nav flex-column">
        <li class="nav-item mb-2"><a href="/myroom/likeZoom" class="nav-link p-0 text-muted">Zoom 강의</a></li>
        <li class="nav-item mb-2"><a href="/myroom/likeVod" class="nav-link p-0 text-muted">Vod 강의</a></li>
      </ul>
    </div>
